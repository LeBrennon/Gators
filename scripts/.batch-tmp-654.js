...
.id .who { flex: 1; }
.id .tclid { height: 82px; width: auto; align-self: center; margin-left: 14px; margin-right: 10px; flex-shrink: 0; }
...
.id h1 { font-family: 'Poppins', Georgia, serif; font-size: 22px; font-weight: 800; color: #33205e; line-height: 1.1; margin-bottom: 3px; }
...
.striptitle { font-family: 'Poppins', Georgia, serif; margin: 0 0 6px; font-size: 10px; font-weight: 700; letter-spacing: 1.8px; color: #33205e; text-transform: uppercase; }
...
h2 { font-family: 'Poppins', Georgia, serif; font-size: 15px; color: #33205e; border-bottom: 2px solid #ecc913; padding-bottom: 4px; margin-bottom: 8px; }
