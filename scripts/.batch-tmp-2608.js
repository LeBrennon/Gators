...
body { margin: 0; font-family: -apple-system, BlinkMacSystemFont, "Helvetica Neue", Arial, sans-serif; color: #020200; background: #2a1a4e url(data:image/jpeg;base64,${croc}) repeat; background-size: 480px auto; }
...
.panel { background: #4e3191; border-radius: 16px; padding: 10px; border: 2px solid #231745; }
...
.gcard { background: #4e3191; border-radius: 14px; padding: 8px 10px; border: 2px solid #231745; }
