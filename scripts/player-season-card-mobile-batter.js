...
.id .tclid { height: 94px; width: auto; align-self: center; margin-left: 0; margin-right: 10px; flex-shrink: 0; background: #fff; border-radius: 10px; padding: 6px; border: 3px solid #ecc913; }
