...
html { background-color: #16102b; background-image: radial-gradient(1100px 550px at 50% -10%, rgba(111,79,212,.10), transparent 60%), linear-gradient(rgba(22,16,43,.12), rgba(22,16,43,.20)), url(data:image/jpeg;base64,${croc}); background-position: center top, center top, center center; background-size: auto, auto, cover; background-repeat: no-repeat; min-height: 100vh; }
body { position: relative; margin: 0; font-family: -apple-system, BlinkMacSystemFont, "Helvetica Neue", Arial, sans-serif; color: #020200; background-color: #16102b; background-image: radial-gradient(1100px 550px at 50% -10%, rgba(111,79,212,.10), transparent 60%), linear-gradient(rgba(22,16,43,.12), rgba(22,16,43,.20)), url(data:image/jpeg;base64,${croc}); background-position: center top, center top, center center; background-size: auto, auto, cover; background-repeat: no-repeat; min-height: 100vh; }
.wrap { width: 100%; max-width: 100%; margin: 0 auto; padding: 12px 12px 24px; }

/* Header band */
.band { position: relative; height: 90px; overflow: hidden; border-radius: 20px; border: 2px solid #ecc913; margin-bottom: 16px; background: linear-gradient(rgba(22,16,43,.42), rgba(22,16,43,.42)), url(data:image/jpeg;base64,${croc}) center 35% / cover no-repeat #241a4e; }
...
.band .sub { font-family: 'Poppins', Georgia, serif; font-size: 8.5px; font-weight: 700; color: #f0ede4; letter-spacing: 1.6px; text-transform: uppercase; margin-top: 5px; white-space: nowrap; }
...
.strip { background: linear-gradient(rgba(22,16,43,.45), rgba(22,16,43,.45)), url(data:image/jpeg;base64,${croc}) center 35% / cover no-repeat #33205e; border-radius: 18px; padding: 10px 6px; display: grid; grid-template-columns: repeat(${stripCols}, 1fr); gap: 8px 4px; border: 2px solid #ecc913; }
...
/* Totals card */
.totcard { background: linear-gradient(rgba(22,16,43,.45), rgba(22,16,43,.45)), url(data:image/jpeg;base64,${croc}) center 35% / cover no-repeat #33205e; border-radius: 14px; padding: 10px; margin-top: 6px; border: 2px solid #ecc913; }
