...
const tcl = b64('tcl-logo.png', 'image/png');
...
.band .tcl { height: 46px; width: auto; margin-left: auto; background: #fff; border-radius: 7px; padding: 4px; box-sizing: content-box; flex-shrink: 0; }
