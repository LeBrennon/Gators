...
html { background: #1e1238 url(data:image/jpeg;base64,${crocDark}) repeat; background-size: 480px auto; }
body { margin: 0; font-family: -apple-system, BlinkMacSystemFont, "Helvetica Neue", Arial, sans-serif; color: #020200; background: #1e1238 url(data:image/jpeg;base64,${crocDark}) repeat; background-size: 480px auto; }
...
.band .org { font-family: 'Poppins', Georgia, serif; font-weight: 800; font-size: 15px; color: #ffd633; letter-spacing: .5px; white-space: nowrap; }
