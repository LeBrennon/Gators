...
html { background: #1e1238 url(data:image/jpeg;base64,${crocDark}) repeat; background-size: 480px auto; min-height: 100vh; }
body { margin: 0; font-family: -apple-system, BlinkMacSystemFont, "Helvetica Neue", Arial, sans-serif; color: #020200; background: #1e1238 url(data:image/jpeg;base64,${crocDark}) repeat; background-size: 480px auto; min-height: 100vh; }
