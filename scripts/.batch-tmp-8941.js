...
html { background-color: #16102b; background: radial-gradient(1100px 550px at 50% -10%, rgba(111,79,212,.10), transparent 60%), linear-gradient(rgba(22,16,43,.12), rgba(22,16,43,.20)), url(data:image/jpeg;base64,${croc}) center center / cover no-repeat; min-height: 100vh; }
body { position: relative; margin: 0; font-family: -apple-system, BlinkMacSystemFont, "Helvetica Neue", Arial, sans-serif; color: #020200; background-color: #16102b; background: radial-gradient(1100px 550px at 50% -10%, rgba(111,79,212,.10), transparent 60%), linear-gradient(rgba(22,16,43,.12), rgba(22,16,43,.20)), url(data:image/jpeg;base64,${croc}) center center / cover no-repeat; min-height: 100vh; }
