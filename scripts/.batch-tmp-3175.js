...
body { margin: 0; font-family: -apple-system, BlinkMacSystemFont, "Helvetica Neue", Arial, sans-serif; color: #020200; background: #2a1a4e linear-gradient(rgba(24,13,48,.5), rgba(24,13,48,.5)), url(data:image/jpeg;base64,${croc}) repeat; background-size: auto, 480px auto; }
