...
const crocDark = b64('scripts/assets/croc-dark.jpg', 'image/jpeg');
...
html { background: #1e1238 url(data:image/jpeg;base64,${crocDark}) repeat; background-size: 480px auto; background-attachment: fixed; min-height: 100vh; }
body { margin: 0; font-family: -apple-system, BlinkMacSystemFont, "Helvetica Neue", Arial, sans-serif; color: #020200; background: #1e1238 url(data:image/jpeg;base64,${crocDark}) repeat; background-size: 480px auto; background-attachment: fixed; min-height: 100vh; }
.wrap { width: 100%; max-width: 100%; margin: 0 auto; padding: 12px 12px 24px; }

/* Header band */
.band { position: relative; height: 90px; overflow: hidden; border-radius: 20px; border: 2px solid #ecc913; margin-bottom: 16px; background: #241a4e; }
...
.band .org { font-family: 'Poppins', Georgia, serif; font-weight: 800; font-size: 14px; color: #ffd633; letter-spacing: .5px; white-space: nowrap; }
.band .sub { font-family: 'Leckerli One', cursive; font-size: 12px; color: #cfc6ea; letter-spacing: .8px; margin-top: 3px; }
...
.id h1 { font-family: 'Poppins', Georgia, serif; font-size: 22px; font-weight: 800; color: #f4f2ec; line-height: 1.1; margin-bottom: 3px; }
...
.meta div { font-size: 11px; color: #f4f2ec; line-height: 1.3; }
.meta b { color: #ecc913; font-size: 8px; text-transform: uppercase; letter-spacing: .5px; display: block; margin-bottom: 1px; }

/* Season strip - wraps naturally, no horizontal scroll */
.striptitle { font-family: 'Poppins', Georgia, serif; margin: 0 0 6px; font-size: 10px; font-weight: 700; letter-spacing: 1.8px; color: #ecc913; text-transform: uppercase; }
...
.panel { background: #241a4e; border-radius: 16px; padding: 10px; border: 1.5px solid #150c31; }
...
.pleg { font-size: 8.5px; line-height: 1.6; color: #cfc6ea; margin: -3px 0 7px; }
.ld { white-space: nowrap; }
.lsep { color: #ecc913; margin-right: 3px; }
.sg { display: flex; flex-direction: column; gap: 4px; }
.sr { display: flex; justify-content: space-between; align-items: center; font-size: 12px; padding: 2px 0; border-bottom: 1px solid rgba(255,255,255,.15); }
.sr:last-child { border-bottom: none; }
.sr.w { grid-column: 1 / -1; }
.sl2 { color: #e5e0f0; font-weight: 700; letter-spacing: .3px; font-size: 10px; }
.sv2 { color: #ffffff; font-weight: 800; font-variant-numeric: tabular-nums; font-size: 13px; }
.sv2sub { display: flex; flex-direction: column; align-items: flex-end; line-height: 1.15; }
.svsub { font-size: 8px; color: #e5e0f0; font-weight: 700; letter-spacing: .6px; margin-top: 1px; }

/* Game log - card layout, no table, no horizontal scroll */
h2 { font-family: 'Poppins', Georgia, serif; font-size: 15px; color: #ecc913; border-bottom: 2px solid #ecc913; padding-bottom: 4px; margin-bottom: 8px; }
.glog { display: flex; flex-direction: column; gap: 6px; }
.gcard { background: #241a4e; border-radius: 14px; padding: 8px 10px; border: 1.5px solid #150c31; }
.gcard-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 5px; padding-bottom: 4px; border-bottom: 1px solid rgba(255,255,255,.15); }
.gcard-date { font-size: 12px; font-weight: 800; color: #ecc913; }
.gcard-opp { font-size: 11px; color: #e5e0f0; }
...
.gcard-stat .gv { font-size: 15px; font-weight: 800; color: #ffffff; font-variant-numeric: tabular-nums; }
.gcard-stat .gl { font-size: 8.5px; color: #e5e0f0; text-transform: uppercase; letter-spacing: .5px; }
